# Migrating web UI to WildSphere Design System
...
- `@/components/ui/<name>` →
  `@workspace/animal-x-ds/components/ui/<name>`
- `@/lib/utils` (`cn`) → `@workspace/animal-x-ds/lib/utils`
- `@/hooks/use-toast` → `@workspace/animal-x-ds/hooks/use-toast`
