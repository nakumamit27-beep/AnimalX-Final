# Consuming Animal X Design System in Expo apps
...
`artifacts/animal-x-ds/docs/migrating-expo.md` before writing UI.
...
```tsx
import { tokens } from "@workspace/animal-x-ds/tokens";
...
```tsx
import { nativeTheme } from "@workspace/animal-x-ds/lib/native-theme";
import { useColors } from "@workspace/animal-x-ds/hooks/use-colors";
import { useDesignSystemFonts } from "@workspace/animal-x-ds/hooks/use-fonts";
```
...
```tsx
import { Badge } from "@workspace/animal-x-ds/components/native/badge";
import { Button } from "@workspace/animal-x-ds/components/native/button";
import { Card } from "@workspace/animal-x-ds/components/native/card";
```
...
Import and render
`@workspace/animal-x-ds/components/native/button`, then run Expo
