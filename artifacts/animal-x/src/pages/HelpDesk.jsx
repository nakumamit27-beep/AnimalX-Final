...
export default function HelpDesk() {
  ...
  const faqs = [
    ...
    { q: "Why do my likes not increase?", a: "WildSphere uses a real unique-like system — one like per reel per account. If you've already liked a reel, tapping again will unlike it." },
    ...
    { q: "What animals are in the app?", a: "WildSphere has 1,213+ animals across 9 categories: Mammals, Reptiles, Birds, Aquatic, Small Creatures, Trees, Mountains, Sea, and Desert." },
    { q: "Is WildSphere free to use?", a: "Yes! WildSphere is completely free — no premium, no locks. All features including animals, zoo map, reels, travel, and chatbot are free." },
  ];
    ...
    <div className="help-page">
      ...
      {activeTab === "Privacy Policy" && (
        <div className="help-content">
          ...
          <div className="policy-section"><h3>2. Firebase & Storage</h3><p>WildSphere uses Firebase Authentication for secure login and Google Cloud Storage for media files. Your data is encrypted in transit and at rest.</p></div>
      ...
      {activeTab === "Terms" && (
        <div className="help-content">
          ...
          <p className="help-text">By using WildSphere, you agree to these terms.</p>
          <div className="policy-section"><h3>1. Permitted Content</h3><p>WildSphere is exclusively a wildlife and nature platform. You may only upload videos, photos, and descriptions related to animals, wildlife, nature, forests, oceans, birds, reptiles, or conservation.</p></div>
          ...
          <div className="policy-section"><h3>5. Intellectual Property</h3><p>You retain ownership of your content. By uploading, you grant WildSphere a non-exclusive license to display your content on the platform.</p></div>
          <div className="policy-section"><h3>6. Liability</h3><p>WildSphere is not responsible for the accuracy of user-uploaded content. We are a platform, not a publisher.</p></div>
        </div>
      )}
      ...
      {activeTab === "Community" && (
        <div className="help-content">
          ...
          <div className="community-rules">
            {[
              { icon: "✅", title: "Wildlife Only", desc: "Only post animals, wildlife, nature, and conservation content. This is what WildSphere is for." },
