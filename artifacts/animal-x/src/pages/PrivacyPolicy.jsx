    ...
    <div className="policy-page">
      ...
      <div className="policy-body">
        ...
        <div className="policy-section">
          ...
          <p>
            Welcome to <strong>WildSphere</strong> ("we," "our," or "us"). We are committed to protecting your personal information and your right to privacy. This Privacy Policy explains how we collect, use, store, and share information when you use our wildlife social media application.
          </p>
          <p>By using WildSphere, you agree to the collection and use of information in accordance with this policy.</p>
        </div>
        ...
        <div className="policy-section">
          ...
          <ul className="policy-list">
            <li>🦁 To provide, operate, and improve WildSphere services</li>
        ...
        <div className="policy-section">
          ...
          <p>WildSphere is not intended for children under the age of <strong>13</strong>. We do not knowingly collect personal data from children under 13. If you believe a child under 13 has provided us with personal information, please contact us immediately.</p>
        </div>
        ...
        <div className="policy-section">
          ...
          <p>We may update this Privacy Policy periodically. We will notify you of significant changes via an in-app broadcast or notification. Continued use of WildSphere after changes constitutes acceptance of the updated policy.</p>
        </div>
        ...
        <div className="policy-footer-note">
          © 2026 WildSphere · All rights reserved · <a href="mailto:wildlifeanimalfight@gmail.com" className="policy-link">Contact Us</a>
        </div>
      </div>
    </div>
  );
